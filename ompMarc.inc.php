...
//Parte responsávle pelo form
  ...
  /**
    ...
    // Link do livro
    $xmlContent .= '=500  \\\$aDisponível em: ' . htmlspecialchars($publicationUrl) . '. Acesso em: 01.01.1999' . PHP_EOL;
...
$xmlContent = '=LDR  ' . $numeroDeCaracteresFormatado . 'nam 2200289Ia 4500' . PHP_EOL . $xmlContent;
